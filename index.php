<html ng-app="loginPage">
	<head>
		...
		<link rel="stylesheet" href="css/Blue_Theme.css"></link>
		<link rel="stylesheet" href="css/toaster.min.css"></link>
		<link rel="stylesheet" href="js/lib/Graphs/nv.d3.min.css"></link>
		...
		<script src="js/lib/Graphs/d3.min.js"></script>
		<script src="js/lib/Graphs/nv.d3.min.js"></script> 
		<script src="js/lib/Graphs/angular-nvd3.js"></script>
		...
		<script src="js/controller/Billing/ProcessReturn.js"></script>
		<script src="js/controller/Billing/PrintBill.js"></script>
		<script src="js/controller/Billing/RecentTransactions.js"></script>
		...
		<script src="js/controller/Graph/Graphs.js"></script>
		<script src="js/controller/Admin/EmployeeManage.js"></script>
		
	</head>
	<body>
		<div class='ApplicationHeader'>
			<div class='ApplicationTitle'>Ganesh Silks</div>
		</div>
		
		<div ng-view></div>
		<div id="footer">
			<span>Powered by <strong>Yajnesh Padiyar</strong>, version 1.0</span>
		</div>
	</body>
